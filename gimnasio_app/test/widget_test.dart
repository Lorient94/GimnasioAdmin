// Tests desactivados: moved to widget_test.dart.disabled
// Placeholder test file. Provides an empty main so the test runner doesn't
// fail when enumerating test files.
